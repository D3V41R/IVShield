...
int main(void)
{
  ...
  UPDATE_DISPLAYHandle = osThreadNew(StartTask03, NULL, &UPDATE_DISPLAY_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : Relay_Switch_Pin */
  ...
  /*Configure GPIO pin : Cross_Detector_Pin */
  GPIO_InitStruct.Pin = Cross_Detector_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(Cross_Detector_GPIO_Port, &GPIO_InitStruct);
